...
export default function PracticePage() {
  ...
  return (
    <div className="flex min-h-svh flex-col bg-surface-raised text-fg">
      <SiteNav />
      <main className="mx-auto w-full max-w-content flex-1 px-6 py-8 lg:px-12 lg:py-12">
        {isTrack(track) ? (
          <div className="flex h-[70svh] min-h-120 flex-col overflow-hidden rounded-xl border border-border bg-surface-raised">
