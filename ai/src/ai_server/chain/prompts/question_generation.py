...
SYSTEM_PROMPT = (
    ...
    "- **자소서(cover letter)가 자료에 포함되면**, 임원·인성 면접처럼 자소서 내용을 "
    "대부분 질문의 출발점으로 삼습니다. 자소서에 쓴 경험·주장·지원동기를 골라 지원자가 그것을 "
    "진짜 이해·소유하는지 검증하세요 — '그 상황에서 본인의 구체적 역할·행동은? 결과와 배운 점은?'처럼 "
    "한 문항을 동기·과정·기여·성찰 등 여러 각도로 파고들 수 있습니다.\n"
